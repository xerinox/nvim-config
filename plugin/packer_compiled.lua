...
_G.packer_plugins = {
  ...
  ["lualine.nvim"] = {
    loaded = true,
    path = "/home/xerinox/.local/share/nvim/site/pack/packer/start/lualine.nvim",
  ...
  ["nvim-web-devicons"] = {
    loaded = false,
    needs_bufread = false,
    path = "/home/xerinox/.local/share/nvim/site/pack/packer/opt/nvim-web-devicons",
